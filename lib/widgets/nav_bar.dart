...
class CustomCupertinoNavigationBar extends StatefulWidget
  ...
  const CustomCupertinoNavigationBar.large({
    super.key,
    this.largeTitle,
    this.leading,
    this.automaticallyImplyLeading = true,
  ...
  Size get preferredSize {
    ...
    return Size.fromHeight(_kNavBarPersistentHeight + heightForDrawer + heightExtension);
  }

  @override
  State<CustomCupertinoNavigationBar> createState() => _CupertinoNavigationBarState();
}
...
class _CupertinoNavigationBarState extends State<CustomCupertinoNavigationBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color? parentPageScaffoldBackgroundColor =
    ...
    final double persistentHeight =
        _kNavBarPersistentHeight + widget.heightExtension +
        bottomHeight +
        MediaQuery.paddingOf(context).top;
    final double largeHeight =
        persistentHeight + _kNavBarLargeTitleHeightExtension;
    ...
    Widget navBar = _PersistentNavigationBar(
      ...
      heightExtension: widget.heightExtension,
    );
...
class CustomCupertinoSliverNavigationBar extends StatefulWidget {
  ...
  /// {@end-tool}
  const CustomCupertinoSliverNavigationBar.search({
    super.key,
  ...
  @override
  State<CustomCupertinoSliverNavigationBar> createState() =>
...
class _CupertinoSliverNavigationBarState
  ...
  void _setupSearchableAnimation() {
    final Tween<double> persistentHeightTween = Tween<double>(
      begin: _kNavBarPersistentHeight + widget.heightExtension,
      end: 0.0,
    );
    persistentHeightAnimation = persistentHeightTween.animate(
    ...
    largeTitleHeightAnimation = largeTitleHeightTween.animate(
      _animationController,
    );
  }
  ...
  Widget build(BuildContext context) {
    final _NavigationBarStaticComponents components =
        _NavigationBarStaticComponents(
          ...
          previousPageTitle: widget.previousPageTitle,
          userMiddle: _animationController.isAnimating
              ? const Text('')
              : effectiveMiddle,
        ...
        builder: (BuildContext context, Widget? child) {
          return SliverPersistentHeader(
            ...
            delegate: _LargeTitleNavigationBarSliverDelegate(
              ...
              persistentHeight:
                  persistentHeightAnimation.value +
                  MediaQuery.paddingOf(context).top,
              largeTitleHeight: largeTitleHeightAnimation.value,
              alwaysShowMiddle:
                  widget.alwaysShowMiddle && effectiveMiddle != null,
...
class _LargeTitleNavigationBarSliverDelegate
  ...
  double get minExtent =>
      persistentHeight +
      (bottomMode == NavigationBarBottomMode.always ? bottomHeight : 0.0);
  ...
  Widget build(
    ...
    final double largeTitleThreshold =
        maxExtent - minExtent - _kNavBarShowLargeTitleThreshold;
    final bool showLargeTitle = shrinkOffset < largeTitleThreshold;

    // Calculate how much the bottom should shrink.
    final double bottomShrinkFactor = clampDouble(
      shrinkOffset / bottomHeight,
      0,
      1,
    );
  ...
  bool shouldRebuild(_LargeTitleNavigationBarSliverDelegate oldDelegate) {
    return components != oldDelegate.components ||
        ...
        automaticBackgroundVisibility !=
            oldDelegate.automaticBackgroundVisibility ||
...
class _RenderLargeTitle extends RenderShiftedBox {
  ...
  static double _computeTitleScale(
    Size childSize,
  ...
  void performLayout() {
    ...
    childParentData.offset = alignment.alongOffset(
      size - (child.size * _scale) as Offset,
    );
  }
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: _kNavBarPersistentHeight + MediaQuery.paddingOf(context).top + heightExtension,
      child: SafeArea(
              ...
              children: <Widget>[
                SizedBox(
                  width:
                      ...
                      (_kSearchFieldCancelButtonWidth *
        ...
        children: <Widget>[
          ...
          AnimatedBuilder(
            ...
            builder: (BuildContext context, Widget? child) {
              return SizedBox(
                width:
                    animationController.value * _kSearchFieldCancelButtonWidth,
                child: child,
              );
            },
          ),
...
class _TransitionableNavigationBar extends StatelessWidget {
  ...
  bool get userGestureInProgress {
    return Navigator.of(
      componentsKeys.navBarBoxKey.currentContext!,
...
class _NavigationBarTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> children = <Widget>[
      ...
      if (componentsTransition.bottomNavBarBottom != null)
      ...
      if (componentsTransition.topNavBarBottom != null)
...
class _NavigationBarComponentsTransition {
  _NavigationBarComponentsTransition({
    ...
    required TextDirection directionality,
       ...
       bottomAutomaticBackgroundVisibility =
           bottomNavBar.automaticBackgroundVisibility,
       userGestureInProgress =
           topNavBar.userGestureInProgress ||
           bottomNavBar.userGestureInProgress,
  ...
  Widget? get bottomNavBarBackground {
    ...
    final RelativeRectTween positionTween = RelativeRectTween(
        ...
        Offset(forwardDirection * -bottomNavBarBox.size.width, 0.0),
      ),
      begin: from,
    );
  ...
  Widget? get bottomLargeTitle {
    ...
    if (topBackLabel != null) {
      ...
      return slideFromLeadingEdge(
        ...
        curve: Interval(
          0.0,
          animation.status == AnimationStatus.forward ? 0.7 : 1.0,
        ),
        child: FadeTransition(
          opacity: fadeOutBy(0.6),
          child: Align(
    ...
    return PositionedTransition(
      rect:
          ...
          ? routeAnimation
                ...
                .drive(positionTween)
          : animation
                .drive(CurveTween(curve: animationCurve))
                .drive(positionTween),
  ...
  Widget? get topBackChevron {
    ...
    return PositionedTransition(
      rect: routeAnimation
          .drive(CurveTween(curve: effectivePositionCurve))
          .drive(positionTween),
      child: FadeTransition(
